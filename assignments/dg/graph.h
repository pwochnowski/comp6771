...
struct shared_pointer_store {
  ...
  bool operator==(const shared_pointer_store<T>& r) const { return *ptr_ == *r.ptr_; }
...
struct unique_pointer_store {
  ...
  bool operator==(const unique_pointer_store<T>& r) const { return *ptr_ == *r.ptr_; }
...
class AdjacencyList {
 public:
  ...
  class const_iterator {
   public:
    ...
    friend bool operator==(const const_iterator& lhs, const const_iterator& rhs) {
      return (lhs.outer_ == rhs.outer_ &&
              (lhs.inner_ == rhs.inner_ || lhs.outer_ == rhs.backSentinel_ ||
               lhs.outer_ == rhs.frontSentinel_));
    }
    friend bool operator!=(const const_iterator& lhs, const const_iterator& rhs) {
      return !(lhs == rhs);
    }
   ...
   private:
    typename std::map<shared_pointer_store<N>, std::set<shared_pointer_store<E>>>::const_iterator
        outer_;
    typename std::map<shared_pointer_store<N>, std::set<shared_pointer_store<E>>>::const_iterator
        frontSentinel_;
    typename std::map<shared_pointer_store<N>, std::set<shared_pointer_store<E>>>::const_iterator
    ...
    const_iterator(
        const typename std::map<shared_pointer_store<N>,
                                std::set<shared_pointer_store<E>>>::const_iterator& outer,
        const typename std::map<shared_pointer_store<N>,
                                std::set<shared_pointer_store<E>>>::const_iterator& frontSentinel,
        const typename std::map<shared_pointer_store<N>,
                                std::set<shared_pointer_store<E>>>::const_iterator& backSentinel,
        const typename std::set<shared_pointer_store<E>>::const_iterator& inner)
      : outer_{outer}, frontSentinel_{frontSentinel}, backSentinel_{backSentinel}, inner_{inner} {}
 ...
 public:
  class const_iterator {
   ...
   private:
    ...
    const typename std::map<shared_pointer_store<N>, AdjacencyList<N, E>>::const_iterator
        frontSentinel_;
    const typename std::map<shared_pointer_store<N>, AdjacencyList<N, E>>::const_iterator
        backSentinel_;
